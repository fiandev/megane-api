export const lists = [
  ...
  },
  {
    ...
    description: "API that can be used to search for detailed information from a region of Indonesia.",
  },
  {
    ...
    description: "An API based on the NIK format and parses any available data.",
  },
  {
    name: "shortlink API",
    icon: "https://cloud.githubusercontent.com/assets/180698/10263413/77ab7474-69ee-11e5-905a-cee324f3564b.png",
    path: "/docs/shortlink",
    description: "API that can help in creating new shortlinks without needing to visit the relevant shortlink website."
  },
];
